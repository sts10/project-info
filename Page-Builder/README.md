...
Page Builder is a tool designed to bring simplicity and accessibility to the task of website creation. It enables anyone, regardless of their technical knowledge or financial capabilities, to build lightweight, single-page websites that are substantially smaller than the average site. Our goal is inclusivity, especially considering those in regions where internet censorship is an unfortunate reality. For enhanced privacy and security, the websites created through Page Builder work seamlessly on the Tor Browser's highest security setting. Now it's incredibly easy to privately share rich offline HTML via Signal, or to quickly launch an onion site using OnionShare, further widening the accessibility and usability of the tool. Ultimately, Page Builder is about enabling everyone to freely publish information online and contribute to the global digital dialogue.
